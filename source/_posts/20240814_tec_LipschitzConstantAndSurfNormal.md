...
曲线的切向量(TangentAt) = 一阶导(DerivativeAt)的单位化向量。

曲线的曲率(CurvatureAt)的模长  $k(t) = \frac{\|r'(t)\times r''(t)\|}{\|r'(t)\|^3}$。 模长越大，曲线越弯曲；模长的倒数为曲线的曲率半径。

曲线的曲率向量(CurvatureAt) 与曲线的切向/一阶导方向垂直。指示了曲线的弯曲方向。